  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        <p className="text-secondary font-heading font-bold text-xl md:text-3xl mb-3 flex items-center justify-center gap-2">
          <img src={geuLogo} alt="" className="h-8 md:h-10 w-auto" />
          GEU Alumni Connect
        </p>
