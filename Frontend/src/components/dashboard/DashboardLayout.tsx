      ...
      <header className="sticky top-0 z-50 gradient-primary shadow-lg shadow-primary/10 animate-fade-down">
        <div className="max-w-[1400px] mx-auto flex items-center justify-between px-4 lg:px-6 h-16">
          <Link to="/dashboard" className="flex items-center gap-3 group">
            <img src={geuLogo} alt="GEU Logo" className="h-10 w-auto brightness-0 invert" />
            <div className="hidden sm:block">
              <span className="font-heading font-bold text-white text-lg tracking-tight">GEU Alumni</span>
              <span className="text-white/70 text-[10px] block leading-none -mt-1 font-medium">Connect</span>
            </div>
          </Link>
